...
baseurl = 'https://www.zainabchottani.com'

r = requests.get('https://www.zainabchottani.com/wedding-festive-21', headers=headers)
soup = BeautifulSoup(r.text, 'lxml')
productList = soup.find('div', {'class': 'item-grid'})
...
# testlink = 'https://www.zainabchottani.com/harika'
...
for link in productLinks:
    ...
    status =  soup.find('input', class_='button-1 add-to-cart-button').attrs['value']
