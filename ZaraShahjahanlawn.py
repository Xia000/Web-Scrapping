...
r = requests.get('https://zarashahjahan.com/collections/lawn-2021', headers=headers)
soup = BeautifulSoup(r.content, 'lxml')
productlist = soup.find_all('div', class_='productList')
...
# testlink = 'https://cdn.shopify.com/s/files/1/0340/8376/6405/files/ajax-loader.gif?v=1613636759'
