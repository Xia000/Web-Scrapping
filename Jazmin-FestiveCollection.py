...
baseUrl = 'https://jazmin.pk'

r = requests.get('https://jazmin.pk/collections/chiffon-1', headers=headers)
soup = BeautifulSoup(r.content, 'lxml')
productlist = soup.find_all('div', class_='grid grid--uniform grid--collection small--grid--flush')
