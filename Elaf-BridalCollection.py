...
r = requests.get('https://www.elafpremium.com/collections/ebc', headers=headers)
...
for link in productlinks:
    ...
    try:    
        stock = soup.find('div', class_='label label--out-stock mb-3 mr-3 text-nowrap').text.strip()
    except:
        stock = 'Add To Cart'
